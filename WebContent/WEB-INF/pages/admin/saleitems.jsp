...
<body>
<h1>Smart Veggie House: Sell Vendor Items</h1>
<div class="container" style="width:960px">
	...
	<div class="form-group">
				...
				<input id='outletName' class="form-control" type="text" style="width:200px" value="${outlet.outletName}" readonly="true"/> 
	...
	<div class="form-group">
				...
				<input id='subOutletCode' class="form-control" type="text" name='subOutletCode' style="width:200px" value="${subOutlet.subOutletCode}" readonly="true"/>
				<label for="subOutletName">SubOutlet Name:</label>
				<input id='subOutletName' class="form-control" type="text" style="width:200px" value="${subOutlet.subOutletName}" readonly="true"/>
	</div>
