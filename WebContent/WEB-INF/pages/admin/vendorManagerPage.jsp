...
<body onload="load();">
	<h1>Smart Veggie House: Vendor Manager</h1>
	<div class="container"style="width:1000px">
		<form class="form-horizontal" action='admin' commandName="userForm">
		<h2><center>Welcome Vendor Manager : ${userForm.firstName} ${userForm.lastName}</h2>
		<br>
			<a href="openvendoritem.html?username=${userForm.userName}" style="text-decoration: underline;margin-left:50px;font-weight:bold">Add Vendor Items</a>
		</form>
	</div>	
</body>
<script>
